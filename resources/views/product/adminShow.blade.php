            ...
            <form action="/admin/product/{{ $product->id }}" id="form" name="form" method="post">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <label for="in_stock">
                                <input type="checkbox" name="in_stock" id="in_stock" {{ ($product->in_stock == 1)?'checked':'' }}
                                    class="checkbox checkbox-md">
                ...
                <div>
                    ...
                    <form action="/admin/product/{{ $product->id }}/extragroup" method="post">
                        ...
                        <div class="input-group my-4">
                          <select name="extragroup_id" class="select select-bordered w-max">
                              <option selected disabled>-- selectionnez un groupe --</option>
